    ...
    <div className="py-8 dark:bg-black bg-white w-full">
      ...
      <WorldMap
        dots={[
          ...
          { start: { lat: 34.0522, lng: -118.2437 }, end: { lat: 40.7128, lng: -74.006 } }, // Los Angeles -> New York (IEEE USA)
          { start: { lat: 40.7128, lng: -74.006 }, end: { lat: 45.4215, lng: -75.6972 } }, // New York -> Ottawa (IEEE Canada)
          { start: { lat: 38.7223, lng: -9.1393 }, end: { lat: 48.8566, lng: 2.3522 } }, // Lisbon -> Paris (IEEE France)
          { start: { lat: 48.8566, lng: 2.3522 }, end: { lat: 52.52, lng: 13.405 } }, // Paris -> Berlin (IEEE Germany)
          { start: { lat: 52.52, lng: 13.405 }, end: { lat: 59.3293, lng: 18.0686 } }, // Berlin -> Stockholm (IEEE Sweden)
          ...
          { start: { lat: 25.276987, lng: 55.296249 }, end: { lat: 28.6139, lng: 77.209 } }, // Dubai -> New Delhi (IEEE India)
          { start: { lat: 28.6139, lng: 77.209 }, end: { lat: 13.7563, lng: 100.5018 } }, // New Delhi -> Bangkok (IEEE Thailand)
          { start: { lat: 13.7563, lng: 100.5018 }, end: { lat: 35.6895, lng: 139.6917 } }, // Bangkok -> Tokyo (IEEE Japan)
          { start: { lat: 35.6895, lng: 139.6917 }, end: { lat: 37.5665, lng: 126.978 } }, // Tokyo -> Seoul (IEEE South Korea)
          { start: { lat: 37.5665, lng: 126.978 }, end: { lat: -33.8688, lng: 151.2093 } }, // Seoul -> Sydney (IEEE Australia)
          ...
          { start: { lat: 19.4326, lng: -99.1332 }, end: { lat: 40.7128, lng: -74.006 } }, // Mexico City -> New York (Loop back to IEEE USA)
        ]}
      />
    </div>
  );
